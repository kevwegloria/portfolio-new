        ...
        <div className={`navigation ${visible ? '' : 'hidden'}`}>
            ...
            <div className='hamburger-container'>
                ...
                <ul className={`nav-list ${isOpen ? 'open' : ''}`}>
                    ...
                    <li><a href="https://docs.google.com/document/d/1rXD3XgxAnbQzV7gIRIpCXH4Xg-V0E0cL/edit?usp=sharing&ouid=112916005114193758573&rtpof=true&sd=true">My Resume</a></li>
